...
<body @php(body_class())>
  ...
  <div id="app">
    ...
    <header class="parallax-bg" style="background-image: url('https://louhosdigital.fi/_thumbs/wManage/data/userfiles/images/1000x1000_595030_301020_WhiteLiiga-netti-85.webp'); height: 650px;">
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <aside class="sidebar col-md-4 pt-6">
          <?php
