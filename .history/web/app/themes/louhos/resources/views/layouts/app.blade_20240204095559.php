...
<body @php(body_class())>
  ...
  <div id="app">
    ...
    <header class="parallax-bg" style="background-image: url('https://images.pexels.com/photos/6109677/pexels-photo-6109677.jpeg'); background-position: bottom; height: 500px;">
