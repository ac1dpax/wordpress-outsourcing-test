...
<html @php(language_attributes())>
  ...
  <section class="jumbotron text-center" style="background-image: url('{{ get_the_post_thumbnail_url($homePage->ID, 'full') }}'); background-size: cover; background-position: top; height: 650px;">
    <div class="container">
      <h1 class="display-4">{{ $homePage->post_title }}</h1>
      <div class="lead">{!! apply_filters('the_content', $homePage->post_content) !!}</div>
