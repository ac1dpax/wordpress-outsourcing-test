...
<body @php(body_class())>
  ...
  <div id="app">
    ...
    <header class="parallax-bg" style="background-image: url('https://images.pexels.com/photos/2892618/pexels-photo-2892618.jpeg'); background-position: top; height: 500px;">
